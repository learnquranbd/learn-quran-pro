...
const TAJWEED_LESSONS = {
  ghunnah: { group: 'core', letters: 'نّ مّ',
  ...
  qalqalah: { group: 'core', letters: 'ق ط ب ج د',
  ...
  ikhfa: { group: 'noon', letters: 'ت ث ج د ذ ز س ش ص ض ط ظ ف ق ك',
  ...
  idghaam_ghunnah: { group: 'noon', letters: 'ي ن م و',
  ...
  idghaam_no_ghunnah: { group: 'noon', letters: 'ل ر',
  ...
  ikhfa_shafawi: { group: 'meem', letters: 'ب',
  ...
  idghaam_shafawi: { group: 'meem', letters: 'م',
  ...
  madd_munfasil: { group: 'madd', letters: 'ا و ي + ء',
  ...
  madd_muttasil: { group: 'madd', letters: 'ا و ي + ء',
  ...
  idghaam_mutaqaribayn: { group: 'other', letters: 'ق/ك ل/ر …',
  ...
  hamzat_wasl: { group: 'other', letters: 'ٱ',
  ...
  lam_shamsiyyah: { group: 'other', letters: 'ال + sun letters',
      ...
      <div class="rounded-xl bg-white dark:bg-gray-800 border ${open ? 'border-2' : 'border-gray-200 dark:border-gray-700'}" ${open ? `style="border-color:${def.color}"` : ''}>
        <button data-tj-rule="${key}" class="w-full flex items-center gap-3 px-3 py-3 text-left hover:bg-gray-50 dark:hover:bg-gray-700/40 rounded-xl">
          ...
          <span class="flex-1 min-w-0">
            <span class="block font-semibold text-sm text-gray-800 dark:text-gray-100">${this.esc(def.label)}</span>
